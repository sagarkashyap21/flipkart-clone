...
<div style={{border: "",alignItems:"center",height:"60px",display:"flex",backgroundColor:"#2874f0" }}>
    <ul style={{border: "",marginTop:"10px",marginLeft:"150px",listStyle:"none",display:"flex",alignItems:"center"}}>
        ...
        <li style={{border:"",marginLeft:"20px",height:"35px",backgroundColor:"white",display:"flex",alignItems:"center"}}><input style={{width:"400px",border:"0"}} type="search" placeholder="Search for products,brands and more"  /><i style={{color:"blue",marginLeft:"40px",marginRight:"10px"}} class="fa fa-solid fa-magnifying-glass"></i></li>
